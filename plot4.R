plot4 <- function(a = NULL) {
  ...
  png(filename="ExData_Plotting1/plot4.png", width=480, height=480, units="px", bg="transparent")
  ...
  # Plot 1,1 chart
  plot(x=subset$DateTime, xlab="", ylab="Global Active Power", y=subset$Global_active_power, type="l", col="black")
  
  # Plot 1,2 chart
  plot(x=subset$DateTime, xlab="datetime", y=subset$Voltage, ylab="Voltage", type="l", col="black")
  ...
  # Plot 2,2 chart
  plot(x=subset$DateTime, xlab="datetime", y=subset$Global_reactive_power, ylab="Global_reactive_power", type="l", col="black")
